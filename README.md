...
│ └── xa_constant.py
│
├── proofs/ ← written contextual analyses
│ ├── 00_README.md
│ ├── 01_yang_mills.md
│ ├── 02_navier_stokes.md
│ ├── 03_riemann.md
...
│ └── 11_langlands.md
│
├── modules/ ← executable notebooks
│ ├── 01_yang_mills.ipynb
│ ├── 02_navier_stokes.ipynb
│ ├── 03_riemann.ipynb
│ ├── 04_p_vs_np.ipynb
│ ├── 05_hodge.ipynb
│ ├── 06_bsd.ipynb
│ ├── 07_poincare_3d.ipynb
│ ├── 08_poincare_4d.ipynb
│ ├── 09_collatz.ipynb
│ ├── 10_abc.ipynb
│ └── 11_langlands.ipynb
│
├── data/ ← human-readable outputs
├── validation/ ← machine-readable diagnostics
